...
const fieldStyles = {
  base: [
    '[&>[data-slot=control]>*]:rounded-xl *:data-[slot=control]:after:rounded-xl',
  ...
  variants: {
    ...
    placeholderTransition: [
      ...
      '[&>[data-slot=control]>*]:pt-[calc(--spacing(6.5)-1px)] sm:[&>[data-slot=control]>*]:pt-[calc(--spacing(5.5)-1px)] [&>[data-slot=control]>*]:pb-[calc(--spacing(2.5)-1px)] sm:[&>[data-slot=control]>*]:pb-[calc(--spacing(2)-1px)]',
      '[&>[data-slot=control]>*:placeholder-shown]:py-4.25 sm:[&>[data-slot=control]>*:placeholder-shown]:py-3.5',
      ...
      '*:data-[slot=label]:text-xs *:data-[slot=label]:transition-all *:data-[slot=label]:text-obsidian-400 *:data-[slot=label]:absolute *:data-[slot=label]:top-1.75 *:data-[slot=label]:left-4',
    ],
  },
}
